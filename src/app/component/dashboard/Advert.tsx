...
import { Typography,Card, Button, Box, CardContent,Grid } from "@mui/material";
...
<Card sx={{height:"252px", width:"334px", marginTop:"20px", marginLeft:"20px" , borderRadius:"5px"}}>
  <CardContent>
  <Grid display={'flex'}>
  <Typography sx={{ color: '#1A56B1', fontSize: { xs: '20px', sm: '20px' }, lineHeight: '30px' , font:'Poppins', fontWeight:'600', width:'250px'}}>
              Get a Myntra <br/>
              Voucher Worth<br/>
              ₹ 500</Typography>
              <Image src="friendship 1.svg" alt="friendship" width={61} height={62} style={{marginLeft:'0px'}} />
              </Grid>
              <Box>
                 <Image src="check 1.svg" alt="check" width={15} height={15} style={{marginTop:"10px",}}/>
                 <Typography variant="body2" sx={{marginLeft:'20px', marginTop:'-20px'}}>
